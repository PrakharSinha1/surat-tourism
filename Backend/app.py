...
# ─── CLEANUP (one-time use — safe GET route) ─────────────────────────────────

@app.route("/admin/cleanup-events")
def cleanup_events():
    """Wipe duplicate events and reseed clean defaults — open in browser once"""
    try:
        with connect_db() as conn:
            c = conn.cursor()
            c.execute("DELETE FROM live_events")
            ...
            I = "https://cdn-ip.allevents.in/s/rs:fill:500:250/g:sm/sh:100/"
            default_events = [
                ("Manoj Muntashir's Krishna",
                 "Experience the story of Krishna beyond mythology, into emotion and philosophy. Narrated live by Manoj Muntashir.",
                 "Sanjeev Kumar Auditorium, Surat", "2026-07-11", "3:00 PM",
                 I + "aHR0cHM6Ly9jZG4tYXouYWxsZXZlbnRzLmluL2V2ZW50czEwL2Jhbm5lcnMvZWVhNGIxNDAtNWZlYi0xMWYxLTliYzAtODdhMTk1MDcxOTViLXJpbWctdzEyMDAtaDYwMC1kYzFjMTIxNC1nbWlyLmpwZz92PTE3ODA1NjAyMzU.avif",
                 "krishna-muntashir"),
                ("Humare Ram ft. Ashutosh Rana",
                 "200+ shows across India. A monumental retelling of the Ramayana now live in Surat with acclaimed actor Ashutosh Rana.",
                 "Sanjeev Kumar Auditorium, Surat", "2026-07-18", "2:30 PM",
                 I + "aHR0cHM6Ly9jZG4tYXouYWxsZXZlbnRzLmluL2V2ZW50czkvYmFubmVycy85MzdmNDFlMC01ZmViLTExZjEtYWY2MC0wNTdmM2ZhYjllMDYtcmltZy13MTIwMC1oNjAwLWRjMWUxNDEzLWdtaXIuanBnP3Y9MTc4MDU2MDA4Mg.avif",
                 "humare-ram"),
                ("I Am Worth It ft. Rajat Sood",
                 "India's Laughter Champion brings his brand-new stand-up hour about love, failure and what actually worked.",
                 "The Green Room, Surat", "2026-07-24", "7:00 PM",
                 I + "aHR0cHM6Ly9jZG4tYXouYWxsZXZlbnRzLmluL2V2ZW50czgvYmFubmVycy8zM2NjZjdhMC02NDJlLTExZjEtOWFlZS1iYmE1YjUyNzgyZmUtcmltZy13MTIwMC1oNjAwLWRjMDUzMDJjLWdtaXIuanBnP3Y9MTc4MTAyODUwMg.avif",
                 "rajat-sood"),
                ("Gaurav Kapoor LIVE",
                 "1M+ YouTube fans — one of India's most prolific stand-up comics brings his live show to Sanjeev Kumar Auditorium.",
                 "Sanjeev Kumar Auditorium, Surat", "2026-07-26", "9:00 PM",
                 I + "aHR0cHM6Ly9jZG4tYXouYWxsZXZlbnRzLmluL2V2ZW50czEvYmFubmVycy9mY2FhY2ZkMC00YjQ3LTExZjEtYWQxMC1hZjFjMDAwMGZlODItcmltZy13MTIwMC1oNjAwLWRjZjY0NDQ0LWdtaXIuanBnP3Y9MTc3ODI5MDc5OA.avif",
                 "gaurav-kapoor"),
                ("Farewell: An Entropy of Separation",
                 "Sold out in Bengaluru and Mumbai. This acclaimed theatrical experience is finally coming to Surat.",
                 "Tara Moti Hall, Surat", "2026-08-01", "8:00 PM",
                 I + "aHR0cHM6Ly9jZG4tYXouYWxsZXZlbnRzLmluL2V2ZW50czQvYmFubmVycy9mOTc3MTlhMC02NDQxLTExZjEtOWM4Ni1jM2QzMjcwZDQ5YTctcmltZy13MTIwMC1oNjAwLWRjZmZmNTI3LWdtaXIuanBnP3Y9MTc4MTAzNjk5NA.avif",
                 "farewell-entropy"),
            ]
            c.executemany("""
            ...
            """, default_events)
            conn.commit()
        return jsonify({"message": "Events cleaned and reseeded successfully", "count": 5})
    except Exception as e:
        return jsonify({"error": str(e)}), 500
